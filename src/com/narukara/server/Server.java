	...
	public static void main(String[] args) {
			...
			public void run() {
				try {
					...
					while (true) {
						...
						executorService.submit(new ClientThread(socket7001));
					}
				} catch (IOException e) {
					e.printStackTrace();
				}
			...
			public void run() {
				try {
					...
					while (true) {
						...
						executorService.submit(new UserThread(socket7002));
					}
				} catch (IOException e) {
					e.printStackTrace();
				}
		...
		try {
			...
			while (true) {
				...
				executorService.submit(new DeviceThread(socket7000));
			}
		} catch (IOException e) {
			e.printStackTrace();
		}
